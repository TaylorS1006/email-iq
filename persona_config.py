...
# substrings against the raw jobtitle string. Dict iteration order matters —
# the first persona with a matching keyword wins, so put more specific/senior
# keywords (e.g. "chief financial officer") ahead of generic ones if a title
# could plausibly match more than one bucket.
